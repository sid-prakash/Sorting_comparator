...
public abstract class AbstractSorter
{
	...
	protected Comparator<Point> pointComparator = null;  // includes class compare which can be used
	...
	{
		if (order != 0 && order != 1) {
			throw new IllegalArgumentException("Enter 0 to compare by x-coordinate or 1 to compare by y-coordinate");
		}
		if (order == 0) {
			Point.setXorY(true);
		}
